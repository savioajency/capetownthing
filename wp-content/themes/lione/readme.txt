...
Please install and activate it before starting to use the theme Lione.
...
Theme documentation is available on http://lione.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Lione is Fontello.
