...
if ( ! function_exists('lione_get_not_selected_text') ) {
	/**
	 ...
	 */
	function lione_get_not_selected_text( $label ) {
		return apply_filters( 'lione_filter_not_selected_text',
								sprintf( apply_filters( 'lione_filter_not_selected_mask', __( '- %s -', 'lione' ) ), $label )
							);
	}
}

if ( ! function_exists( 'lione_get_list_range' ) ) {
	/**
	 ...
	 */
	function lione_get_list_range( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			$list[ $i ] = $i;
		}
...
if ( ! function_exists( 'lione_get_list_styles' ) ) {
	/**
	 ...
	 */
	function lione_get_list_styles( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			// Translators: Add number to the style name 'Style 1', 'Style 2' ...
			$list[ $i ] = sprintf( esc_html__( 'Style %d', 'lione' ), $i );
		}
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_yesno' ) ) {
	/**
	 ...
	 */
	function lione_get_list_yesno( $prepend_inherit = false ) {
		$list = array(
			'yes' => esc_html__( 'Yes', 'lione' ),
			'no'  => esc_html__( 'No', 'lione' ),
		);
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_checkbox_values' ) ) {
	/**
	 ...
	 * @return array                 An associative array with 'yes' and 'no' elements.
	 */
	function lione_get_list_checkbox_values( $prepend_inherit = false ) {
		$list = apply_filters(
			'lione_filter_list_checkbox_values', array(
				1         => esc_html__( 'Yes', 'lione' ),
				0         => esc_html__( 'No', 'lione' ),
			)
		);
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'lione_get_list_onoff' ) ) {
	/**
	 ...
	 */
	function lione_get_list_onoff( $prepend_inherit = false ) {
		$list = array(
			'on'  => esc_html__( 'On', 'lione' ),
			'off' => esc_html__( 'Off', 'lione' ),
		);
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_showhide' ) ) {
	/**
	 ...
	 */
	function lione_get_list_showhide( $prepend_inherit = false ) {
		$list = array(
			'show' => esc_html__( 'Show', 'lione' ),
			'hide' => esc_html__( 'Hide', 'lione' ),
		);
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_visiblehidden' ) ) {
	/**
	 ...
	 */
	function lione_get_list_visiblehidden( $prepend_inherit = false ) {
		$list = array(
			'visible' => esc_html__( 'Visible', 'lione' ),
			'hidden'  => esc_html__( 'Hidden', 'lione' ),
		);
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_directions' ) ) {
	/**
	 ...
	 */
	function lione_get_list_directions( $prepend_inherit = false ) {
		$list = array(
			'horizontal' => esc_html__( 'Horizontal', 'lione' ),
			'vertical'   => esc_html__( 'Vertical', 'lione' ),
		);
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_paddings' ) ) {
	/**
	 ...
	 */
	function lione_get_list_paddings( $prepend_inherit = false ) {
		$list = apply_filters(
			'lione_filter_list_paddings', array(
				'none'  => array(
							'title' => esc_html__( 'No Padding', 'lione' ),
							'icon'  => 'images/theme-options/section-padding/none.png',
						),
				'small'  => array(
							'title' => esc_html__( 'Small Padding', 'lione' ),
							'icon'  => 'images/theme-options/section-padding/small.png',
						),
				'medium' => array(
							'title' => esc_html__( 'Medium Padding', 'lione' ),
							'icon'  => 'images/theme-options/section-padding/medium.png',
						),
				'large' => array(
							'title' => esc_html__( 'Large Padding', 'lione' ),
...
if ( ! function_exists( 'lione_get_list_hovers' ) ) {
	/**
	 ...
	 */
	function lione_get_list_hovers( $prepend_inherit = false ) {
		$list = apply_filters(
			'lione_filter_list_hovers', array(
				'dots'    => esc_html__( 'Dots', 'lione' ),
				'icon'    => esc_html__( 'Icon', 'lione' ),
				'icons'   => esc_html__( 'Icons', 'lione' ),
				'zoom'    => esc_html__( 'Zoom', 'lione' ),
				'fade'    => esc_html__( 'Fade', 'lione' ),
				'slide'   => esc_html__( 'Slide', 'lione' ),
				'pull'    => esc_html__( 'Pull', 'lione' ),
				'border'  => esc_html__( 'Border', 'lione' ),
				'excerpt' => esc_html__( 'Excerpt', 'lione' ),
				'info'    => esc_html__( 'Info', 'lione' ),
			)
		);
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'lione_get_list_blog_contents' ) ) {
	/**
	 ...
	 */
	function lione_get_list_blog_contents( $prepend_inherit = false ) {
		$list = array(
				'excerpt'  => esc_html__( 'Excerpt', 'lione' ),
				'fullpost' => esc_html__( 'Full post', 'lione' ),
		);
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_blog_paginations' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function lione_get_list_blog_paginations( $prepend_inherit = false ) {
		$list = array(
					'pages'    => array(
					...
					'links'    => array(
										'title' => esc_html__( 'Older/Newest', 'lione' ),
...
if ( ! function_exists( 'lione_get_list_sidebars' ) ) {
	/**
	 ...
	 */
	function lione_get_list_sidebars( $prepend_inherit = false, $add_hide = false ) {
		$list = lione_storage_get( 'list_sidebars' );
		if ( '' == $list ) {
			...
			lione_storage_set( 'list_sidebars', $list );
		}
		if ( $add_hide ) {
			$list = lione_array_merge( array( 'hide' => lione_get_not_selected_text( esc_html__( 'Select widgets', 'lione' ) ) ), $list );
		}
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_sidebars_positions' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function lione_get_list_sidebars_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'lione_filter_list_sidebars_positions', array(
				'hide'  => array(
							'title' => esc_html__( 'No sidebar', 'lione' ),
							'icon'  => 'images/theme-options/sidebar-position/hide.png',
						),
				'left'  => array(
							'title' => esc_html__( 'Left sidebar', 'lione' ),
							'icon'  => 'images/theme-options/sidebar-position/left.png',
						),
				'right' => array(
							'title' => esc_html__( 'Right sidebar', 'lione' ),
...
if ( ! function_exists( 'lione_get_list_sidebars_positions_ss' ) ) {
	/**
	 ...
	 */
	function lione_get_list_sidebars_positions_ss( $prepend_inherit = false ) {
		$list = apply_filters(
			'lione_filter_list_sidebars_positions_ss', array(
				'above' => esc_html__( 'Above the content', 'lione' ),
				'below' => esc_html__( 'Below the content', 'lione' ),
				'float' => esc_html__( 'Floating bar', 'lione' ),
			)
		);
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'lione_get_list_sidebar_styles' ) ) {
	/**
	 ...
	 */
	function lione_get_list_sidebar_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'lione_filter_list_sidebar_styles', array() );
		}
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_header_footer_types' ) ) {
	/**
	 ...
	 */
	function lione_get_list_header_footer_types( $prepend_inherit = false ) {
		$list = apply_filters(
			'lione_filter_list_header_footer_types', array(
...
if ( ! function_exists( 'lione_get_list_header_styles' ) ) {
	/**
	 ...
	 */
	function lione_get_list_header_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'lione_filter_list_header_styles', array() );
		}
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_header_positions' ) ) {
	/**
	 ...
	 */
	function lione_get_list_header_positions( $prepend_inherit = false ) {
		$list = array(
			'default' => esc_html__( 'Default', 'lione' ),
			'over'    => esc_html__( 'Over', 'lione' ),
			'under'   => esc_html__( 'Under', 'lione' ),
		);
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_footer_styles' ) ) {
	/**
	 ...
	 */
	function lione_get_list_footer_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'lione_filter_list_footer_styles', array() );
		}
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_body_styles' ) ) {
	/**
	 ...
	 *                                This format used to show elements in the 'icons' style instead dropdown.
	 */
	function lione_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		$list = array(
			'boxed' => array(
						'title' => esc_html__( 'Boxed', 'lione' ),
						'icon'  => 'images/theme-options/body-style/boxed.png',
					),
			'wide'  => array(
						'title' => esc_html__( 'Wide', 'lione' ),
						'icon'  => 'images/theme-options/body-style/wide.png',
					),
		);
		if ( apply_filters( 'lione_filter_allow_fullscreen', $force_fullscreen || lione_get_theme_setting( 'allow_fullscreen' ) || lione_get_edited_post_type() == 'page' ) ) {
			$list['fullwide']   = array(
									'title' => esc_html__( 'Fullwidth', 'lione' ),
									'icon'  => 'images/theme-options/body-style/fullwide.png',
									);
			$list['fullscreen'] = array(
									'title' => esc_html__( 'Fullscreen', 'lione' ),
									'icon'  => 'images/theme-options/body-style/fullscreen.png',
									);
		}
		$list = apply_filters( 'lione_filter_list_body_styles', $list );
		return $prepend_inherit
					? lione_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'lione_get_list_expand_content' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function lione_get_list_expand_content( $prepend_inherit = false, $narrow = false ) {
		$list = apply_filters(
			'lione_filter_list_expand_content', array_merge(
				( $narrow
					? array(
						'narrow' => array(
								'title' => esc_html__( 'Narrow', 'lione' ),
...
if ( ! function_exists( 'lione_get_list_remove_margins' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function lione_get_list_remove_margins( $prepend_inherit = false ) {
		$list = apply_filters(
			'lione_filter_list_remove_margins', array(
				'0'  => array(
							'title' => esc_html__( 'Margins On', 'lione' ),
							'icon'  => 'images/theme-options/remove-margins/on.png',
						),
				'1'  => array(
							'title' => esc_html__( 'Margins Off', 'lione' ),
...
if ( ! function_exists( 'lione_get_list_meta_parts' ) ) {
	/**
	 ...
	 */
	function lione_get_list_meta_parts( $prepend_inherit = false ) {
		$list = apply_filters(
			'lione_filter_list_meta_parts',
			array(
				'author'     => esc_html__( 'Post author', 'lione' ),
				'date'       => esc_html__( 'Published date', 'lione' ),
				'modified'   => esc_html__( 'Modified date', 'lione' ),
				'views'      => esc_html__( 'Views', 'lione' ),
				'likes'      => esc_html__( 'Likes', 'lione' ),
				'comments'   => esc_html__( 'Comments', 'lione' ),
				'share'      => esc_html__( 'Share links', 'lione' ),
				'categories' => esc_html__( 'Categories', 'lione' ),
				'edit'       => esc_html__( 'Edit link', 'lione' ),
			)
		);
...
if ( ! function_exists( 'lione_get_list_share_links_positions' ) ) {
	/**
	 ...
	 */
	function lione_get_list_share_links_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'lione_filter_list_share_links_positions',
			array(
...
if ( ! function_exists( 'lione_get_list_blog_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function lione_get_list_blog_styles( $prepend_inherit = false, $filter = 'arh', $need_custom = true ) {
		$list   = array();
					...
					if ( 'arh' == $filter && isset( $v['columns'] ) && is_array( $v['columns'] ) ) {
						...
						foreach ( $v['columns'] as $col ) {
							...
							$list[ "{$k}_{$col}" ] = 'arh' == $filter
														? array(
															'title'   => sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'lione' ), $v['title'], $col ),
															'icon'    => ! empty( $v['icon'] )
																			? ( strpos( $v['icon'], '%d' ) !== false ? sprintf( $v['icon'], $col ) : $v['icon'] )
																			: 'images/theme-options/blog-style/custom.png',
															'new_row' => $new_row,
															)
														: sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'lione' ), $v['title'], $col );
							$new_row = false;
						}
					} else {
						$list[ $k ] = 'arh' == $filter
		...
		$list = apply_filters( 'lione_filter_list_blog_styles', $list, $filter, $need_custom );
		return $prepend_inherit
					? lione_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'lione_get_list_single_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function lione_get_list_single_styles( $prepend_inherit = false ) {
		$list = apply_filters( 'lione_filter_list_single_styles', lione_storage_get( 'single_styles' ) );
		return $prepend_inherit
					? lione_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'lione_get_list_categories' ) ) {
	/**
	 ...
	 */
	function lione_get_list_categories( $prepend_inherit = false ) {
		$list = lione_storage_get( 'list_categories' );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					$list[ $cat->term_id ] = apply_filters( 'lione_filter_term_name', $cat->name, $cat );
				}
			}
			lione_storage_set( 'list_categories', $list );
		}
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_terms' ) ) {
	/**
	 ...
	 */
	function lione_get_list_terms( $prepend_inherit = false, $taxonomy = 'category' ) {
		$list = lione_storage_get( 'list_taxonomies_' . ( $taxonomy ) );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					...
					$list[ $cat->term_id ] = apply_filters( 'lione_filter_term_name', $cat->name . ( false && 'category' != $taxonomy ? " /{$cat->taxonomy}/" : '' ), $cat );
				}
			}
			lione_storage_set( 'list_taxonomies_' . ( $taxonomy ), $list );
		}
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_posts_types' ) ) {
	/**
	 ...
	 */
	function lione_get_list_posts_types( $prepend_inherit = false ) {
		$list = lione_storage_get( 'list_posts_types' );
		if ( '' == $list ) {
			$list = apply_filters(
				'lione_filter_list_posts_types', array(
					'post' => esc_html__( 'Post', 'lione' ),
				)
			);
			lione_storage_set( 'list_posts_types', $list );
		}
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_posts' ) ) {
	/**
	 ...
	 */
	function lione_get_list_posts( $prepend_inherit = false, $opt = array() ) {
		$opt = array_merge(
			array(
				'post_type'        => 'post',
				'post_status'      => 'publish',
		...
		$list = lione_storage_get( $hash );
		if ( '' == $list ) {
			$list = array();
			if ( false !== $opt['not_selected'] ) {
				$list['none'] = true === $opt['not_selected'] ? lione_get_not_selected_text( esc_html__( 'Not selected', 'lione' ) ) : $opt['not_selected'];
			}
			$args = array(
...
if ( ! function_exists( 'lione_get_list_users' ) ) {
	/**
	 ...
	 */
	function lione_get_list_users( $prepend_inherit = false, $roles = array( 'administrator', 'editor', 'author', 'contributor', 'shop_manager' ) ) {
		$list = lione_storage_get( 'list_users' );
		if ( '' == $list ) {
			$list         = array();
			$list['none'] = lione_get_not_selected_text( esc_html__( 'Not selected', 'lione' ) );
			$users        = get_users(
				array(
			...
			lione_storage_set( 'list_users', $list );
		}
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_menus' ) ) {
	/**
	 ...
	 */
	function lione_get_list_menus( $prepend_inherit = false ) {
		$list = lione_storage_get( 'list_menus' );
		if ( '' == $list ) {
			$list            = array();
			$list['default'] = esc_html__( 'Default', 'lione' );
			...
			lione_storage_set( 'list_menus', $list );
		}
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_icons' ) ) {
	/**
	 ...
	 */
	function lione_get_list_icons( $style ) {
		$lists = get_transient( 'lione_list_icons' );
		if ( ! is_array( $lists ) || ! isset( $lists[ $style ] ) || ! is_array( $lists[ $style ] ) || count( $lists[ $style ] ) < 2 ) {
			if ( 'icons' == $style ) {
				$lists[ $style ] = lione_array_from_list( lione_get_list_icons_classes() );
			} elseif ( 'images' == $style ) {
				$lists[ $style ] = lione_get_list_images();
			} else { // 'svg'
				$lists[ $style ] = lione_get_list_images( false, 'svg' );
			}
			if ( is_admin() && is_array( $lists[ $style ] ) && count( $lists[ $style ] ) > 1 ) {
				set_transient( 'lione_list_icons', $lists, 6 * 60 * 60 );       // Store to the cache for 6 hours
			}
		}
		return $lists[ $style ];
	}
...
if ( ! function_exists( 'lione_get_list_icons_classes' ) ) {
	/**
	 ...
	 * @return array                  An associative array with icons.
	 */
	function lione_get_list_icons_classes( $prepend_inherit = false ) {
		static $list = false;
		if ( ! is_array( $list ) ) {
			$list = ! is_admin() ? array() : lione_parse_icons_classes( lione_get_file_dir( 'css/font-icons/css/fontello-codes.css' ) );
		}
		$list = lione_array_merge( array( 'none' => 'none' ), $list );
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'lione_get_list_images' ) ) {
	/**
	 ...
	 */
	function lione_get_list_images( $prepend_inherit = false, $type = 'png' ) {
...
if ( ! function_exists( 'lione_get_list_sc_color_styles' ) ) {
	/**
	 ...
	 */
	function lione_get_list_sc_color_styles( $prepend_inherit = false ) {
		$list = apply_filters(
			'lione_filter_get_list_sc_color_styles', array(
				'default' => esc_html__( 'Default', 'lione' ),
				'link2'   => esc_html__( 'Accent 2', 'lione' ),
				'link3'   => esc_html__( 'Accent 3', 'lione' ),
				'dark'    => esc_html__( 'Dark', 'lione' ),
			)
		);
		return $prepend_inherit ? lione_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'lione' ) ), $list ) : $list;
	}
