...
$pagination = '<stm-listing-pagination prev="Prev" next="Next" :url="url" :page="paginate.page" v-on:url-update="set_url" v-on:pagination-update="pagination_update" :page_count="paginate.pageCount"></stm-listing-pagination>';
