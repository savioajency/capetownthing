...
$select = '<ulisting-select2 v-if="view_type==\'dropdowns\'" data-v-bind_options="listing_order" v-model="selected" text="label" theme="bootstrap4" autoclear=\'false\'></ulisting-select2>';
