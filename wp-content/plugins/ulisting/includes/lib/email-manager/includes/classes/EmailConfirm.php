...
class EmailConfirm extends UlistingEmail {
	/**
	...
	public function replace_shortcodes( $type, $args ) {
		if ( $type == 'content' ) {
			$content = __( 'Congratulations, You have registered on site - Please activate your account [confirm_button]', 'ulisting' );
		}
		if ( $type == 'subject' ) {
			$content = __( 'Congratulations', 'ulisting' );
		}
